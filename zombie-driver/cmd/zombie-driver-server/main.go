...
import (
	...
	"github.com/heetch/georgysavva-technical-test/driver-location/pkg/driverloc/clients/driverlochttp"
...
func main() {
	...
	driverLocationClient := driverlochttp.NewClient(conf.DriverLocationService.URL)

	zombiePredicate := zombiedriver.NewZombiePredicate(conf.App.ZombiePredicate.DistanceThreshold, conf.App.ZombiePredicate.TimeInterval)
	service := zombiedriver.NewService(driverLocationClient, logger.WithField("component", "service"), zombiePredicate)
